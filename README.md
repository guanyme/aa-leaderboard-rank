...
Open the [LLM leaderboard](https://artificialanalysis.ai/leaderboards/models) (any locale, e.g. `/zh/leaderboards/models`). Every model gets a rank number in front of its name, with the top three in gold, silver and bronze.
